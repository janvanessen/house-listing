...
contract SolnSquareVerifier is HouseListingToken {
    SquareVerifierInterface verifier;
    ...
    constructor(address squareVerifierAddress) public {
        verifier = SquareVerifierInterface(squareVerifierAddress);
    }
    ...
    function addSolution(
        ...
        Solution memory solution = Solution(tokenId, sender);
    ...
    function mintToken(
        ...
        require(
            submittedSolutions[hash].sender == address(0),
