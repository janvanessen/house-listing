...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != ownerOf(tokenId), "Given addres is owner of the tokenId");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(
            msg.sender == getOwner() ||
                isApprovedForAll(getOwner(), msg.sender),
            "Sender is not an approved address"
        );
    ...
    function getApproved(uint256 tokenId) public view returns (address) {
        ...
        require(approved != address(0), "Token approval does not exist");
        return approved;
    }
    ...
    function setApprovalForAll(address to, bool approved) public {
        require(to != msg.sender, "Not sender");
    ...
    function transferFrom(
        ...
        require(_isApprovedOrOwner(msg.sender, tokenId), "Invalid sender");
...
contract ERC721Enumerable is ERC165, ERC721 {
    ...
    function tokenOfOwnerByIndex(address owner, uint256 index)
        ...
        returns (uint256)
    {
        require(index < balanceOf(owner), "Index higher than balance");
    ...
    function tokenByIndex(uint256 index) public view returns (uint256) {
        require(index < totalSupply(), "Index higher than total supply");
